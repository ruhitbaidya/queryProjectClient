...
const AllQuery = () => {
  ...
  useEffect(() => {
    axios
      .get("https://crud-server-alternative-product.vercel.app/findProduct", { withCredentials: true })
      .then((res) => {
  ...
  const handelSearch = (e)=>{
      ...
      axios
      .get(`https://crud-server-alternative-product.vercel.app/searchproduct/${text}`, { withCredentials: true })
      .then((res) => {
