...
const MyQueries = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://query-project-server.vercel.app/getProductByEmailalternative?email=${email}`, {
  ...
  const handelDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://query-project-server.vercel.app/delete/${id}`).then((res) => {
