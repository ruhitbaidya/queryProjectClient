...
const QueryDetails = () => {
  ...
  const handelAddSubmit = (e)=>{
    ...
    axios.post("https://queryserver.vercel.app/comment", infos,{withCredentials : true})
    .then((res)=> {
...
useEffect(()=>{
    axios.get( `https://queryserver.vercel.app/allcomment/${data._id}`, {withCredentials : true})
    .then((res)=>{
      setComment(res.data)
    })
}, [data._id])
