	...
	<div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">Sleek design, unmatched performance, and seamless integration. This product revolutionizes productivity. A must-have for anyone serious about efficiency.</p>
		...
		<div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">Incredible performance, intuitive interface, and stunning display. This product redefines excellence. Worth every penny. Couldn t be happier with my purchase</p>
